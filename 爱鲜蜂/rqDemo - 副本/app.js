...
function clearColor(){
	console.log(1);
	$(".ulid1 a:eq(0)").css({"background":"url(img/b1.png) no-repeat center 0.07rem",
	"background-size": "0.24rem"});
	$(".ulid1 a:eq(1)").css({"background":"url(img/b2.png) no-repeat center 0.07rem",
	"background-size": "0.24rem"});
	$(".ulid1 a:eq(2)").css({"background":"url(img/b3.png) no-repeat center 0.07rem",
	"background-size": "0.24rem"});
	$(".ulid1 a:eq(3)").css({"background":"url(img/b4.png) no-repeat center 0.07rem",
	"background-size": "0.24rem"});
}